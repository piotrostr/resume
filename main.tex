...
\section{Volunteer Experience}
  \resumeSubHeadingListStart
    \resumeSubheading{Lancaster University Investment & Finance Society (500+ members) – VP IT}{Lancaster, United Kingdom}
    {Automated the retrieval of financial data to display portfolio metrics}{June 2020 – January 2021}
  \vspace{5pt}
    \resumeSubheading{Lancaster University Ghosal Investment Fund (58 analysts) – Portfolio Manager}{Lancaster, United Kingdom}
    {Programmed a back-tester that takes OHLC data, checks outcomes of a given strategy and graphs performance}{January 2020 – June 2020}
\resumeSubHeadingListEnd
